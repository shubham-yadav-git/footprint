...
JET_INDEX_DASHBOARD = 'demo.custom_dashboard.CustomDashboard'
# JET_APP_INDEX_DASHBOARD = 'demo.custom_dashboard.CustomAppIndexDashboard'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        # (``social-account`` app) containing the required client
